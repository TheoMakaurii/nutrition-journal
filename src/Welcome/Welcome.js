...
export default function Welcome(){
    return(
        <div className ='WelcomeBox'>
            ...
            <h2> Lets talk about goals! </h2>
            <p>If you're reading this page it means that you are motivated for one reason or another to tackle your nutrion habits in a new way. That is so awesome! </p>
            
            <p>Maybe you need to bulk up with clean calories. </p>
                
           <p> Maybe you had an uncomfortable conversation with your doctor. </p>
            
            <p>Maybe you forget to eat sometimes and binge eat other times.</p> 
